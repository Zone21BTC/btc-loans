...
**Action:** update
**By:** tocomax
**Commit:** [c6c02894](https://github.com/your-repo/commit/c6c02894)
**Message:** feat: update interest rate on 10/28/2025

### Changed
- **details.apr_min.value:** `5.9` → `6`
- **details.apr_max.value:** `5.9` → `6`
- **details.interest_rate_min.value:** `5.9` → `6`
...
**Action:** update
**By:** tocomax
**Commit:** [aa0e7303](https://github.com/your-repo/commit/aa0e7303)
**Message:** feat: update interest rate 11/25/2025

### Changed
- **details.apr_min.value:** `5.2` → `5`
- **details.apr_max.value:** `5.2` → `5`
- **details.interest_rate_min.value:** `5.2` → `5`
- **details.interest_rate_max.value:** `5.2` → `5`
...
### Changed
- **details.apr_min.value:** `5` → `3.7`
- **details.apr_max.value:** `5` → `3.7`
- **details.interest_rate_min.value:** `5` → `3.7`
- **details.interest_rate_max.value:** `5` → `3.7`
...
### Changed
- **details.apr_min.value:** `3.7` → `3.6`
- **details.apr_max.value:** `3.7` → `3.6`
- **details.interest_rate_min.value:** `3.7` → `3.6`
- **details.interest_rate_max.value:** `3.7` → `3.6`

---
## 2025-12-24
**Action:** update
**By:** tocomax
**Commit:** [3a965b18](https://github.com/your-repo/commit/3a965b18)
**Message:** feat: update interest rate 12/24/2025

### Changed
- **details.apr_min.value:** `3.6` → `4.2`
- **details.apr_max.value:** `3.6` → `4.2`
- **details.interest_rate_min.value:** `3.6` → `4.2`
- **details.interest_rate_max.value:** `3.6` → `4.2`

---
## 2025-12-30
**Action:** update
**By:** tocomax
**Commit:** [7bef8a58](https://github.com/your-repo/commit/7bef8a58)
**Message:** feat: update interest rate 12/30/2025

### Changed
- **details.apr_min.value:** `4.2` → `6.1`
- **details.apr_max.value:** `4.2` → `6.1`
- **details.interest_rate_min.value:** `4.2` → `6.1`
- **details.interest_rate_max.value:** `4.2` → `6.1`
...
### Changed
- **details.apr_min.value:** `6.1` → `5.3`
- **details.apr_max.value:** `6.1` → `5.3`
- **details.interest_rate_min.value:** `6.1` → `5.3`
- **details.interest_rate_max.value:** `6.1` → `5.3`
